...
**Additionally, per [[EverSiteAudit Master Governance]] §V (Knowledge Graph Protocol), you MUST update the EverSiteAudit Knowledge Graph after every change.** This includes modifying affected notes, creating new notes for new entities, updating domain index links, and verifying zero broken wikilinks and zero orphaned files.
