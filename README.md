...
AAA-grade cross-platform mobile application built with React Native / Expo.
...
- Truth Score Threshold: **0.95** (standard), **0.99** (security-critical)
- Test Coverage Minimum: **70%**
- Security Standard: **OWASP ASVS Level 3**
