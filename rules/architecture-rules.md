...
The app must function 100% without an internet connection. All data lives locally in SQLite. Cloud is only used for:
- Manual backup file sharing (user-initiated)
- Nothing else.
